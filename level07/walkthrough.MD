...
The program seems to be a storage service, but it will not be efficient to do test all the inputs manually, so it is better to see if there is a way to exploit it.
